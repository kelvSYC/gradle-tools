...
class SesJavaBasePluginSpec : FunSpec() {
    init {
        test("Apply - Registers client info type") {
            ...
            clients.createableTypes shouldContain SesClientInfo::class.java
            clients.createableTypes shouldContain SesAsyncClientInfo::class.java
        }
    }
}
