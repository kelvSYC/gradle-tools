...
/**
 * Specialization of [AbstractBatchDownloadFromAzureBlobStorage] integrating it with the clients-base core.
 */
...
) : AbstractBatchDownloadFromAzureBlobStorage(objects, providers, workerExecutor) {
