 ...
 */
abstract class AbstractDecimal64Bits<T>(protected val bits: Long) : DecimalFloatingPointBits<T, Long> {
    companion object {
        /**
         * The number of bits in a `decimal64` value.
         */
        const val SIZE_BITS = Long.SIZE_BITS

        /**
         * The number of bits in the continuation field of a `decimal64` value.
         */
        const val CONTINUATION_WIDTH = 50

        /**
         * The number of bits in the combination field of a `decimal64` value.
         */
        ...
        /**
         * The number of bits in the exponent of a `decimal64` value.
         */
        const val EXPONENT_BITS = COMBINATION_WIDTH - 3

        /**
         * The number of bits in the significand of a `decimal64` value.
         */
        const val SIGNIFICAND_BITS = CONTINUATION_WIDTH + 4

        /**
         * The exponent bias of the `decimal64` type, if the decimal point is placed after the first significant digit.
         */
        const val EXPONENT_BIAS = 384
    ...
    override val combination: Int by bitfield(this::bits, CONTINUATION_WIDTH, COMBINATION_WIDTH, Long::toInt)
    override val continuation: Long by bitfield(this::bits, 0, CONTINUATION_WIDTH)

    private val topBits by bitfield(this::bits, SIZE_BITS - 6, 5, Long::toInt)
