...
class ByteArrayBitwise(size: Int?) : AbstractArrayBitwise<ByteArray, Byte>(size) {
...
class UByteArrayBitwise(size: Int?) : AbstractArrayBitwise<UByteArray, UByte>(size) {
...
class ShortArrayBitwise(size: Int?) : AbstractArrayBitwise<ShortArray, Short>(size) {
...
@OptIn(ExperimentalUnsignedTypes::class)
class UShortArrayBitwise(size: Int?) : AbstractArrayBitwise<UShortArray, UShort>(size) {
...
class IntArrayBitwise(size: Int?) : AbstractArrayBitwise<IntArray, Int>(size) {
...
@OptIn(ExperimentalUnsignedTypes::class)
class UIntArrayBitwise(size: Int?) : AbstractArrayBitwise<UIntArray, UInt>(size) {
...
class LongArrayBitwise(size: Int?) : AbstractArrayBitwise<LongArray, Long>(size) {
...
@OptIn(ExperimentalUnsignedTypes::class)
class ULongArrayBitwise(size: Int?) : AbstractArrayBitwise<ULongArray, ULong>(size) {
