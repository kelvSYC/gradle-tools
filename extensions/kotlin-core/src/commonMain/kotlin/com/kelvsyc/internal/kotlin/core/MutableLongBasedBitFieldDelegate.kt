...
class MutableLongBasedBitFieldDelegate<T>(
    backingProperty: KMutableProperty0<Long>,
    off: Int,
    len: Int,
    converter: Converter<Long, T>
) : AbstractMutableBitFieldDelegate<T, Long>(backingProperty, off, len, converter) {
