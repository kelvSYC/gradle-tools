...
class MutableShortBasedBitFieldDelegate<T>(
    backingProperty: KMutableProperty0<Short>,
    off: Int,
    len: Int,
    converter: Converter<Short, T>
) : AbstractMutableBitFieldDelegate<T, Short>(backingProperty, off, len, converter) {
